<header class="header">
  ...
  <nav class="main-navigation" id="main-navigation">
    ...
    <a
      href="index.php"
      class="navigation__link <?= $_SERVER["REQUEST_URI"] === "/" || $_SERVER["REQUEST_URI"] === "/index.php"
    ...
    <?php if ($user) : ?>
      <a
        ...
        class="navigation__link <?= $_SERVER["REQUEST_URI"] === "/profile.php" ? "navigation__link--active" : "" ?>"
    ...
    <?php else : ?>
      <a
        ...
        class="navigation__link <?= $_SERVER["REQUEST_URI"] === "/login.php" ? "navigation__link--active" : "" ?>"
        title="Connexion">
        <span class="emoji-shadow" aria-hidden="true">🔑</span>
      ...
      <a
        ...
        class="navigation__link <?= $_SERVER["REQUEST_URI"] === "/signup.php" ? "navigation__link--active" : "" ?>"
        title="Inscription">
        <span class="emoji-shadow" aria-hidden="true">📝</span>
